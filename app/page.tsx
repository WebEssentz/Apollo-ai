    ...
    <div className="min-h-screen-patched bg-background flex w-full">
      <main className="min-h-screen-patched relative flex-1">
        <div className="flex min-h-screen flex-col items-center justify-center">
          {/* Header */}
          <header 
            className={`fixed left-0 top-0 z-50 w-full bg-background transition-all duration-300`}
          >
            <div className="w-full">
              <nav className="flex h-16 items-center justify-between px-0">
                <Link
                  href="/"
                  className="flex items-center gap-2.5 hover:opacity-90 transition-all duration-300 pl-3"
                >
                  <Image
                    src={'/logo.svg'}
                    alt='Apollo logo'
          ...
          <div className="flex-col items-center justify-center gap-6 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-32 sm:pt-48">
            {/* Hero Section */}            
            <div 
              className="flex flex-col items-center gap-[0.3] sm:gap-1 text-center"
            >
